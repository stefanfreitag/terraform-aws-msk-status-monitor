...
| <a name="input_log_retention_period_in_days"></a> [log\_retention\_period\_in\_days](#input\_log\_retention\_period\_in\_days) | Number of days logs will be retained. Default is `365`. | `number` | `365` | no |
